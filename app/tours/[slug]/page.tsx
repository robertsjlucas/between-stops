    ...
    <main className="publicTourPage">
      ...
      <section className="publicTourHero">
        ...
        <div className="publicTourIntro">
          ...
          <p className="publicTourDataNote">Location access keeps the tour in sync. Audio and images stream using Wi-Fi or mobile data.</p>
        </div>
      </section>
      ...
      <section className="publicTourFinalCta"><p className="publicTourKicker">READY WHEN YOU ARE</p><h2>Take the story with you.</h2><Link href={`/tours?tour=${tour.experience.id}`}>Start experience →</Link><small>Streams audio and images. Offline downloads are planned.</small></section>
